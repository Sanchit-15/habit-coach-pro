...
export default function MyHabits() {
  ...
  const [form, setForm] = useState({ name: '', goal: '', frequency: 'daily', time: 'morning' });

  const resetForm = () => { setForm({ name: '', goal: '', frequency: 'daily', time: 'morning' }); setEditId(null); setShowForm(false); };
  ...
  const handleEdit = (habit) => {
    setForm({ name: habit.name, goal: habit.goal, frequency: habit.frequency, time: habit.time });
    setEditId(habit.id);
    setShowForm(true);
  };
